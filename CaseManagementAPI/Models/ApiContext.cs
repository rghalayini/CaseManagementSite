        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Case>(entity =>
            {
                ...
                entity.HasOne(d => d.CaseStatus)
                    ...
                    .HasConstraintName("FK__Cases__CaseStatu__2C3393D0");

                entity.HasOne(d => d.CaseWorker)
                    .WithMany(p => p.Cases)
                    .HasForeignKey(d => d.CaseWorkerId)
                    .HasConstraintName("FK__Cases__CaseWorke__2A4B4B5E");

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.Cases)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("FK__Cases__CustomerI__2B3F6F97");
            });
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.HasOne(d => d.Case)
                    ...
                    .HasConstraintName("FK__Comments__CaseId__30F848ED");

                entity.HasOne(d => d.CaseWorker)
                    .WithMany(p => p.Comments)
                    .HasForeignKey(d => d.CaseWorkerId)
                    .HasConstraintName("FK__Comments__CaseWo__2F10007B");

                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.Comments)
                    .HasForeignKey(d => d.CustomerId)
                    .HasConstraintName("FK__Comments__Custom__300424B4");
            });
