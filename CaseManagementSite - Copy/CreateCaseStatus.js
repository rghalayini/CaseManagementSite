...
var print=document.getElementById("createCaseStatusForm");
console.log(print);
// document.getElementById("createCustomerForm").addEventListener("submit", newCustomer())
// document.getElementById("createCaseWorkerForm").addEventListener("submit", newCaseWorker())
// document.getElementById("createCaseStatusForm").addEventListener("submit", newCaseStatus())
// document.getElementById("createCaseForm").addEventListener("submit", newCase())
